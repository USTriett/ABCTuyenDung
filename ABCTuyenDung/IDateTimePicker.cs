...
{
    public class IDatePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        public IDatePicker()
        {
            ...
            this.MaximumSize = new Size(200, 60);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat())
            {
                ...
                //Draw icon
                graphics.DrawImage(calendarIcon, this.Width - calendarIcon.Width, (this.Height - calendarIcon.Height) / 2);
